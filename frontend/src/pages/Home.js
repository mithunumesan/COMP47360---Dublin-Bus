...
export function useUserToken() {
    ...
    useEffect(() => {
      ...
      fetch('https://137.43.49.30:443/loginapi/username/', {
            method: 'GET',
...
function Home() {
   ...
   useEffect(()=>{
    if(userid){
        url = 'https://137.43.49.30:443/loginapi/details/' + userid + '/';
    ...
    var deleteRoute = () => {
        ...
        let url = 'https://137.43.49.30:443/loginapi/details/' + userinfo + '/';
        console.log(url);
        fetch(url, {
            method: 'DELETE',
            }).then(
    ...
    var populateRoute = (e) => {
        ...
        let url = 'https://137.43.49.30:443/loginapi/routes/' + userinfo + '/';
        console.log(url);
        fetch(url, {
            method: 'GET',
            }).then(
