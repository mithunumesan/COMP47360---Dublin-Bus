...
export function useUserToken() {
    ...
    useEffect(() => {
      ...
      fetch('http://137.43.49.30:80/loginapi/username/', {
            method: 'GET',
...
function Home() {
   ...
   useEffect(()=>{
    if(userid){
        url = 'http://137.43.49.30:80/loginapi/details/' + userid + '/';
    ...
    var deleteRoute = () => {
        ...
        let url = 'http://137.43.49.30:80/loginapi/details/' + userinfo + '/';
        console.log(url);
        fetch(url, {
            method: 'DELETE',
            }).then(
    ...
    var populateRoute = (e) => {
        ...
        let url = 'http://137.43.49.30:80/loginapi/routes/' + userinfo + '/';
        console.log(url);
        fetch(url, {
            method: 'GET',
            }).then(
